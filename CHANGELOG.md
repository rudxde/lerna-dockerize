...
* **generate:** don't ignore install parameters in base docker stage install ([01ca83c](https://github.com/rudxde/lerna-dockerize/commit/01ca83c7a3e0e11b3cc87d13b1d7074c42cd334b)), closes [#972](https://github.com/rudxde/lerna-dockerize/issues/972)
...
* **generate:** keep steps before first stage of base dockerfile ([9427d3f](https://github.com/rudxde/lerna-dockerize/commit/9427d3f97bd3e6234838f7bb0417356010504c87)), closes [#350](https://github.com/rudxde/lerna-dockerize/issues/350)
...
## [0.8.3](https://github.com/rudxde/lerna-dockerize/compare/v0.8.2...v0.8.3) (2022-01-04)


### Bug Fixes

* do not interpret npm i dependency install as npm i ([876188f](https://github.com/rudxde/lerna-dockerize/commit/876188f8c7b7daea5e7cf2925543cbc4f84f77c6))
...
# [0.8.0](https://github.com/rudxde/lerna-dockerize/compare/v0.7.1...v0.8.0) (2021-08-31)


### Features

* **extended-syntax:** use lerna run for npm run scripts with variable ([a20ff10](https://github.com/rudxde/lerna-dockerize/commit/a20ff1054b34fc350b315203372b3dc8e4627920))
